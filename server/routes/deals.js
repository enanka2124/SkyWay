...
const mockDeals = [
  { id: 1, title: 'Mumbai → Goa Weekend', category: 'Domestic', from: 'Mumbai', to: 'Goa', originalPrice: 4999, dealPrice: 1999, discount: 60, image: 'https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?w=400&q=80', validUntil: '2026-05-15', description: 'Escape to the beaches this weekend!' },
  ...
  { id: 10, title: 'Delhi → Udaipur Romance', category: 'Domestic', from: 'Delhi', to: 'Udaipur', originalPrice: 5499, dealPrice: 2799, discount: 49, image: 'https://images.unsplash.com/photo-1602217345592-39a0babc73c2?w=400&q=80', validUntil: '2026-06-05', description: 'City of Lakes at dream prices' },
