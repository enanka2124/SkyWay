...
const fallbackRoutes = [
  { id: 1,  from: 'Mumbai',    fromCode: 'BOM', to: 'Goa',       toCode: 'GOI', price: 2499,  duration: '1h 10m', stops: 'Direct' },
  { id: 2,  from: 'Delhi',     fromCode: 'DEL', to: 'Bangalore', toCode: 'BLR', price: 3199,  duration: '2h 40m', stops: 'Direct' },
  { id: 3,  from: 'Bangalore', fromCode: 'BLR', to: 'Chennai',   toCode: 'MAA', price: 1899,  duration: '1h 5m',  stops: 'Direct' },
  { id: 4,  from: 'Mumbai',    fromCode: 'BOM', to: 'Dubai',     toCode: 'DXB', price: 12499, duration: '3h 15m', stops: 'Direct' },
  { id: 5,  from: 'Delhi',     fromCode: 'DEL', to: 'Jaipur',    toCode: 'JAI', price: 2199,  duration: '1h 5m',  stops: 'Direct' },
  { id: 6,  from: 'Mumbai',    fromCode: 'BOM', to: 'Kolkata',   toCode: 'CCU', price: 4299,  duration: '2h 35m', stops: 'Direct' },
  { id: 7,  from: 'Hyderabad', fromCode: 'HYD', to: 'Delhi',     toCode: 'DEL', price: 3599,  duration: '2h 10m', stops: 'Direct' },
  { id: 8,  from: 'Chennai',   fromCode: 'MAA', to: 'Mumbai',    toCode: 'BOM', price: 3399,  duration: '1h 50m', stops: 'Direct' },
  { id: 9,  from: 'Delhi',     fromCode: 'DEL', to: 'Manali',    toCode: 'KUU', price: 3999,  duration: '1h 30m', stops: 'Direct' },
  { id: 10, from: 'Bangalore', fromCode: 'BLR', to: 'Goa',       toCode: 'GOI', price: 2699,  duration: '1h 15m', stops: 'Direct' },
  { id: 11, from: 'Mumbai',    fromCode: 'BOM', to: 'Singapore', toCode: 'SIN', price: 15999, duration: '5h 30m', stops: 'Direct' },
  { id: 12, from: 'Delhi',     fromCode: 'DEL', to: 'Bangkok',   toCode: 'BKK', price: 11999, duration: '4h 20m', stops: 'Direct' },
  { id: 13, from: 'Kolkata',   fromCode: 'CCU', to: 'Bangalore', toCode: 'BLR', price: 4599,  duration: '2h 45m', stops: 'Direct' },
  { id: 14, from: 'Hyderabad', fromCode: 'HYD', to: 'Dubai',     toCode: 'DXB', price: 14999, duration: '3h 45m', stops: 'Direct' },
  { id: 15, from: 'Delhi',     fromCode: 'DEL', to: 'Udaipur',   toCode: 'UDR', price: 2899,  duration: '1h 20m', stops: 'Direct' },
  { id: 16, from: 'Mumbai',    fromCode: 'BOM', to: 'Jaipur',    toCode: 'JAI', price: 3499,  duration: '2h 0m',  stops: 'Direct' },
  ...
  { id: 20, from: 'Chennai',   fromCode: 'MAA', to: 'Colombo',   toCode: 'CMB', price: 8999,  duration: '1h 25m', stops: 'Direct' },
  ...
  { id: 23, from: 'Pune',      fromCode: 'PNQ', to: 'Delhi',     toCode: 'DEL', price: 3499,  duration: '2h 10m', stops: 'Direct' },
  { id: 24, from: 'Ahmedabad', fromCode: 'AMD', to: 'Mumbai',    toCode: 'BOM', price: 2199,  duration: '1h 5m',  stops: 'Direct' },
  { id: 25, from: 'Kolkata',   fromCode: 'CCU', to: 'Kathmandu', toCode: 'KTM', price: 7999,  duration: '1h 45m', stops: 'Direct' },
]
